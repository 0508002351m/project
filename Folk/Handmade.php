...
talent_work inner join category on talent_work.Cat_id = category.id inner join  department on department.Id=category.Dep_id inner join users  on  talent_work.User_id = users.id where department.Id=3 ";
...
<div class="card" style="width: 18rem;">
  ...
  <img class="img-fluid h-100 w-100" src="./Admin/Works/uploads/<?php echo $data['Image']; ?> alt="Card image cap" >
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <h5 class="card-title"><a href="blog-details.html"><?php echo $data['Name'] . ' ( ' . $data['Name'] . ')'; ?></a></h5>
